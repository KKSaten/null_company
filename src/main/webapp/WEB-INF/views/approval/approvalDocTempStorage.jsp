				...
				<div class="page-inner">
					...
					<div class="page-header mt-3">
						...
						<ul class="breadcrumbs mb-1">
							...
							<li class="nav-item">
								<a href="/approval/approvalDocTempStorage">임시보관함</a>
							</li>
						</ul>
					</div>
										...
										<table id="appr-doc-table" class="table table-striped">
											<thead>
												<tr>
													...
													<th style="font-size: 15px !important; letter-spacing:0px !important; width: 30%;">결재 라인</th>
												</tr>
											</thead>
														    	...
														    	<c:forEach items="${item.apprLineVO}" var="approver">
															        ...
															        <div class="approver-group">
															        	...
															        	<div class="${approver.apprProgress == '최종승인' ? 'approver-inProgress'
															        		...
															        		: 'approver'}">
															        		<c:choose>
															        			<c:when test="${empty approver.approverName}">
															        				작성중
															        			</c:when>
															        			<c:otherwise>
